...
OUTPUT_DIR="/home/ubuntu/4catalyzer-hackathon/opt/run-final-day-2/"
...
accelerate launch --mixed_precision="fp16" train_instruct_pix2pix.py \
    ...
    --train_batch_size=10 --gradient_accumulation_steps=4 \
    --max_train_steps=50000 \
    --checkpointing_steps=75 --checkpoints_total_limit=10 \
